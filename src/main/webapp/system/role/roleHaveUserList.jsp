...
String id=(String)request.getParameter("id");//岗位id
%>
<!DOCTYPE html>
<html>
<head>
  ...
  <!-- Content Wrapper. Contains page content -->
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="#">角色所属用户</a></li> 
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <button type="button" class="btn btn-default btn-sm" id="add_user" >
              <span class="fa  fa-object-ungroup"></span> 撤销关联
            </button>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
...
<div class="modal fade" name="myModal" id="confirm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">确定要撤销选中数据的关联</div>
            <div class="modal-footer">
...
<script src="roleHaveUserList.js"></script>
<!-- page script -->
