  ...
  <!-- Content Wrapper. Contains page content -->
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="#">系统菜单</a></li>   
      </ol>
    </section>
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <button type="button" class="btn btn-default btn-sm" id="expand">
              <span class="fa fa-expand"></span> 展开全部
            </button> 
            <button type="button" class="btn btn-default btn-sm" id="compress">
              <span class="fa fa-compress"></span> 收缩全部
            </button> 
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped  table-hover">
                        <tr>
                             <th class="col-xs-1 font-center">
                                <input name="checked_all_info" type="checkbox" value=""/>
                             </th>
                             <th class="col-xs-3 font-center">菜单名</th>
                             <th class="col-xs-1 font-center">序号</th>
                             <th class="col-xs-2 font-center">菜单状态</th>
                             <th class="col-xs-3 font-center">描述</th>
                        </tr>
              </table>
            </div>
            <!-- /.box-body -->
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel"><b>菜单添加页面</b></h4>
            </div>
            <div class="modal-body" >
            <iframe src="MenuAdd.jsp" class="largerModel" frameborder="0" scrolling="no" name="adduser_content"></iframe>
            </div>
...
<div class="modal fade" name="myModal" id="editUser" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title" id="myModalLabel"><b>菜单修改页面</b></h4>
            </div>
            <div class="modal-body" >
            <iframe src="MenuEdit.jsp" class="largerModel" frameborder="0" scrolling="no" name="editUser_content"></iframe>
            </div>
            <div class="modal-footer">
