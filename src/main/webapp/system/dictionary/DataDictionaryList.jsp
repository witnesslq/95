  ...
  <!-- Content Wrapper. Contains page content -->
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="#">数据字典</a></li>   
      </ol>
    </section>
    ...
    <div class="modal-dialog">
        <div class="modal-content mymodal-width">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel"><b>添加数据字典</b></h4>
            </div>
            <div class="modal-body" >
            <iframe src="DataDictionaryAdd.jsp" class="smallModel" frameborder="0" scrolling="no" name="adduser_content"></iframe>
            </div>
...
<div class="modal fade" name="myModal" id="editUser" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content mymodal-width">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title" id="myModalLabel"><b>修改数据字典</b></h4>
            </div>
            <div class="modal-body" >
            <iframe src="DataDictionaryEdit.jsp" class="smallModel" frameborder="0" scrolling="no" name="editUser_content"></iframe>
            </div>
            <div class="modal-footer">
