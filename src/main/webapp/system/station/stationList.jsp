  ...
  <!-- Content Wrapper. Contains page content -->
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="#">岗位管理</a></li>   
      </ol>
    </section>
          ...
          <div class="box">
            ...
            <button type="button" class="btn btn-default btn-sm" id="detele_user">
             ...
             <button type="button" class="btn btn-default btn-sm" id="own_user">
              <span class="fa  fa-users"></span> 所属用户
            </button> 
            </div>
            <!-- /.box-header -->
            <div class="box-body">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel"><b>岗位信息添加</b></h4>
            </div>
            <div class="modal-body" >
            <iframe src="stationAdd.jsp" class="small-amsllModel" frameborder="0" scrolling="no" name="adduser_content"></iframe>
            </div>
...
<div class="modal fade" name="myModal" id="editUser" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title" id="myModalLabel"><b>修改岗位信息</b></h4>
            </div>
            <div class="modal-body" >
            <iframe src="stationEdit.jsp" class="small-amsllModel" frameborder="0" scrolling="no" name="editUser_content"></iframe>
            </div>
            <div class="modal-footer">
...
<!-- page script -->   
<script src="<%=basePath  %>/system/station/stationList.js"></script> 
</body>
</html>
