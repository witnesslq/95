    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel"><b>添加部门信息</b></h4>
            </div>
            <div class="modal-body" >
            <iframe src="CorpAdd.jsp" class="smallModel" frameborder="0" scrolling="no" name="adduser_content"></iframe>
            </div>
...
<div class="modal fade" name="myModal" id="editUser" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title" id="myModalLabel"><b>修改部门信息</b></h4>
            </div>
            <div class="modal-body" >
            <iframe src="CorpEdit.jsp" class="smallModel" frameborder="0" scrolling="no" name="editUser_content"></iframe>
            </div>
            <div class="modal-footer">
