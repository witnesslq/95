...
<div class="wrapper">
 ...
 <form class="form-horizontal" role="form">
  <div class="form-group form-group-sm ">
    <label for="postname" class="col-xs-2 control-label nopadding font-size">职务名称<font class="muststyle">(必填)</font>
    </label>
   ...
   <div class="form-group form-group-sm ">
    <label for="ordernum" class="col-xs-2 control-label nopadding font-size">职务排序<font class="muststyle">(必填)</font>
    </label>
      <div class="col-xs-9 nopadding">
   ...
   <div class="form-group form-group-sm ">
    <label for="ordernum" class="col-xs-2 control-label nopadding font-size">所属部门<font class="muststyle">(必填)</font>
    </label>
      <div class="col-xs-9 nopadding">
   ...
   <div class="form-group form-group-sm">
      <label for="remark" class="col-xs-2 control-label nopadding font-size">职务描述</label>
       <div class="col-xs-9 nopadding">
