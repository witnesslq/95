...
<head>
  ...
  <![endif]-->
   <link rel="stylesheet" href="<%=basePath  %>/css/daterangepicker-bs2.css">
   <link rel="stylesheet" href="<%=basePath  %>/css/daterangepicker-bs3.css">
...
<script src="syslogList.js"></script>
