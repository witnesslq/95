                ...
                fields: [ 
                    ...
                    { label: "客户经理",name: "manager",newline: true,type: "popupedit",
						editor: {
                			condition: {
                   			 	prefixID: 'condtion_',
                    			fields: [{ name: 'username',type:'text', label: '客户经理' }]
                			},
                			readonly:true,
                    ...
                    { label: "客户省份",name: "province",newline: true,type: "select",
						editor:{
...
<body style="padding:10px">   
	   <div style="text-align: center;width:98%;margin-bottom: 10px;" ><font size="5em">集团客户信息展示</font></div>
	   <div id="main">
	   		<form id="form"></form>
	   	</div>
