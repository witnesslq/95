...
public class FlowModel {
	...
	private String sumthevalue;    //最大流量
	private String avgthevalue;    //平均流量
	...
	public String getSumthevalue() {
		return sumthevalue;
	}

	public void setSumthevalue(String sumthevalue) {
		this.sumthevalue = sumthevalue;
	}

	public String getAvgthevalue() {
		return avgthevalue;
	}

	public void setAvgthevalue(String avgthevalue) {
