...
<form class="form-horizontal" role="form">
  <div class="form-group form-group-sm ">
    <label for="postname" class="col-xs-2 control-label nopadding font-size">类别<font class="muststyle">(必填)</font>
    </label>
   ...
   <div class="form-group form-group-sm ">
    <label for="ordernum" class="col-xs-2 control-label nopadding font-size">代码<font class="muststyle">(必填)</font>
    </label>
      <div class="col-xs-9 nopadding">
   ...
   <div class="form-group form-group-sm ">
    <label for="ordernum" class="col-xs-2 control-label nopadding font-size">值<font class="muststyle">(必填)</font>
    </label>
      <div class="col-xs-9 nopadding">
...
<script src="ConfigEdit.js"></script>
<!-- page script -->
