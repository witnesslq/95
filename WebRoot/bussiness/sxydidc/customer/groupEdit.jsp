    ...
    <script type="text/javascript">
        ...
        $(function (){
        	form = $("#form").ligerForm({
				...
				validate : true,
                fields: [ 
               		{ label: "客户编号",name: "no",newline: true,type: "text",validate: {required: true}},
                    { label: "客户类型",name: "type",newline: false,type: "select",readonly:true,
                        editor:{
                    		data:[{id:"01",text:"集团客户"},{id:"03",text:"互联网客户"}],
                    		initValue:"01"
                    	},
                    ...
                    { label: "联系人",name: "contactname",newline: true,type: "text"},
