    ...
    <div class="modal-dialog">
        <div class="modal-content mymodal-width">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel"><b>添加机房信息</b></h4>
            </div>
            <div class="modal-body" >
            <iframe src="rsroomAdd.jsp" class="add-user" frameborder="0" scrolling="no" name="adduser_content"></iframe>
            </div>
...
<div class="modal fade" name="myModal" id="editUser" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content mymodal-width">
            ...
            <div class="modal-body" >
            <iframe src="rsroomEdit.jsp" class="add-user" frameborder="0" scrolling="no" name="editUser_content"></iframe>
            </div>
            <div class="modal-footer">
...
<div class="modal fade" name="myModal" id="detailUser" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content mymodal-width">
            ...
            <div class="modal-body" >
            <iframe src="rsroomView.jsp" class="add-user" frameborder="0" scrolling="no" name="content_info"></iframe>
            </div>
            <div class="modal-footer">
...
<!-- page script -->   
<script src="rsroomList.js"></script>
