...
<div class="wrapper">
 ...
 <form class="form-horizontal" role="form">
  <div class="form-group form-group-sm ">
   ...
   <div class="form-group form-group-sm ">
      <label for="needRack" class="col-xs-2 control-label nopadding font-size">是否添加机架</label>
	    <div  class="col-xs-4 input-sm nopadding ">
			<select class="form-control" id="needRack">
		        <option value=""></option>
       ...
       <label for="racktype" class="col-xs-2 control-label nopadding1 font-size">机架规格</label>
		     <div  class="col-xs-4 input-sm nopadding ">
				<select class="form-control" id="racktype">
			       <option value=""></option>
					<option value="42">42U机架</option>
					<option value="46">46U机架</option>
				</select>
		     </div>      
  </div>
   ...
   <div class="form-group form-group-sm ">
    ...
    <label for="height" class="col-xs-2 control-label nopadding1 font-size">宽(米)</label>
     ...
     <div class="form-group form-group-sm ">
    <label for="areaid" class="col-xs-2 control-label nopadding font-size">所属区域<font class="muststyle">(必填)</font></label>
    </label>
    <div class="col-xs-4 nopadding">
    ...
    <label for="status" class="col-xs-2 control-label nopadding1 font-size">是否启用<font class="muststyle">(必填)</font></label></label>
   	<div class="col-xs-4 nopadding">
...
<script src="rsroomAdd.js"></script>
<!-- page script -->
