...
<div class="wrapper">
 ...
 <form class="form-horizontal" role="form">
  <div class="form-group form-group-sm ">
   ...
   <div class="form-group form-group-sm ">
    <label for="typeid" class="col-xs-2 control-label nopadding font-size">机架规格
    </label>
    <div  class="col-xs-4 input-sm nopadding ">
        <select class="form-control" id="typeid" readonly>
	    </select>
	</div>
   ...
   <div class="form-group form-group-sm">
       ...
       <label for="dcname" class="col-xs-2 control-label nopadding1 font-size">所属客户</label>
		     <div  class="col-xs-4 input-sm nopadding ">
