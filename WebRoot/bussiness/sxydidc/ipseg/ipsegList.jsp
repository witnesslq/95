...
<head>
    ...
    <script  type="text/javascript"  src="ipsegList.js"></script> 
</head>
<body>  
	<div class="btnArea">
    	<span style="display:block; float:right">
      		...
      		<input id="splitBtn" class="btn_l" name="" type="button" value="网段拆分"/>
      		<input id="mergeBtn" class="btn_l" name="" type="button" value="网段合并"/>
    	</span>
