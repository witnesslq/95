		...
		function getDatacenter(){
			$.ajax({
				...
				success:function (msg) {
					...
					$.ligerui.get("companyId").setData([{id:msg.companyId,text:msg.companyname}]);
					$.ligerui.get("regionId").setData([{id:msg.regionId,text:msg.regionname}]);
				}, 
				error:function (error) {
					alert("获取数据中心信息失败" + error.status);
				}
