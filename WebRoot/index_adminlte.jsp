...
<html lang="zh">
  <head>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="<%=basePath  %>/node_modules/admin-lte/plugins/iCheck/flat/blue.css">
  ...
  <body class="hold-transition skin-blue sidebar-mini">
    ...
    <!-- jQuery UI 1.11.4 -->
    <script src="<%=basePath  %>/node_modules/admin-lte/plugins/jQueryUI/jquery-ui.min.js"></script>
